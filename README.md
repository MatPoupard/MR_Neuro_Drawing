# MR_Vascu_Drawing: Mixed Reality Application for Neuroanatomy Drawing
...
<img src="https://github.com/user-attachments/assets/36550494-5755-422e-b1f2-92195239a898" width="300"/>
...
<img src="https://github.com/user-attachments/assets/455bbf18-27ec-4692-9601-eaac3d158cfc" width="300"/>

You can find a video demonstration on https://youtu.be/bN2Br_fCvEU.

## Installation

Follow this [Microsoft guide](https://learn.microsoft.com/en-us/windows/mixed-reality/develop/advanced-concepts/using-visual-studio?tabs=hl2#deploying-a-hololens-app-over-wi-fi-or-usb) to deploy the app on HoloLens by using Visual Studio.

## Usage

1. Start the application on the HoloLens 2 device.
2. Choose the version : with our without 3D brain model
3. Place the paper with QR codes in the camera's view to activate the tracking system.
4. Use the floating menu to adjust and switch the anatomical structure overlays.
5. In the 3D model version, user can interact with the 3D model by hands

<img src="https://github.com/user-attachments/assets/9ac2828e-fa29-4617-a182-099575b73ae9" width="300"/>
